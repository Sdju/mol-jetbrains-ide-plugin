...
public class ViewTreeComponentAttributesImpl extends ASTWrapperPsiElement implements ViewTreeComponentAttributes {

  public ViewTreeComponentAttributesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViewTreeVisitor visitor) {
    visitor.visitComponentAttributes(this);
  }
