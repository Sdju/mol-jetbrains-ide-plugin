...
public class ViewTreeArrayItemsValueImpl extends ASTWrapperPsiElement implements ViewTreeArrayItemsValue {

  public ViewTreeArrayItemsValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViewTreeVisitor visitor) {
    visitor.visitArrayItemsValue(this);
  }
